...
public class Assignment2 {
    ...
    public static int[][] popRand(int[][] array) {
        //takes in an int[][], populates randomly, returns as an int[][]
    ...
    public static void display(int[][] array) {
        //takes in an int[][], displays it in the console
    ...
    public static void findSum(int[][] array) {
        //takes in an int[][], finds the highest possible sum from a 3x3 grid
        int tempsum = 0;
        int sum = 0;
