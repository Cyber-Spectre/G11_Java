...
class CS30 {
  ...
  public static void display() {//?displays a menu of options
  ...
  public static int[] popSeq(int[] arr) {//?populates arr[] sequentially from 0-99
  ...
  public static int[] popRand(int[] arr) {//?populates arr[] randomly
    for (int x = 0; x < arr.length; x++) {
  ...
  public static void sortChek(int[] arr) {//?checks if arr[] is sorted in ascending order
    for (int x = 0; x < arr.length - 1; x++) {
      if (arr[x] > arr[x + 1]) {
        System.out.println("Array is not sorted");
        return;
  ...
  public static void displayArr(int[] arr) {//?displays arr[] in rows of 10
    System.out.println("\n");
    for (int x = 0; x < 10; x++) {
      String row = x + "X: ";
      for (int y = 0; y < 10; y++) {
  ...
  public static int[] shuf(int[] arr) {//?shuffles the array randomly
    for (int x = 0; x < arr.length; x++) {
      int temp = arr[x];
  ...
  public static void findLin(int[] arr) {//?finds an inputted number in arr[] with linear search
  ...
  public static int findBin(int[] arr, int key, int hi, int lo) {//?finds an inputted number in arr[] with recursive binary search
    if (lo <= hi) {
  ...
  public static void bubSort(int[] arr) {//?sorts arr[] using Bubble Sort
    for (int x = 0; x < arr.length - 1; x++) {
  ...
  public static void insSort(int[] arr) {//?sorts arr[] using Insertion Sort
    int stepBack = 1;
  ...
  public static void selSort(int[] arr) {//?sorts arr[] using Selection Sort
    for (int x = 0; x < arr.length; x++) {
  ...
  public static void quikSort(int[] arr, int lo, int hi) {//?sorts arr[] using QuickSort
    if (lo < hi) {
  ...
  public static void radSort(int[] arr) {//?sorts arr[] using Radix Sort
  ...
  public static void mergeSort(int[] arr, int l, int h) {//?sorts arr[] using Merge Sort
    if (l < h) {
      ...
      int[] lArr = new int[lS], hArr = new int[hS]; //arrays for lower and higher range
